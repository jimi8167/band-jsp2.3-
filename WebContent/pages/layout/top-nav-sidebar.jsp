		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item"><a href="../layout/top-nav-sidebar.jsp"
							class="nav-link"> <i class="nav-icon fas fa-search"></i>
								<p>밴드 찾기</p>
						</a></li>

						<li class="nav-item"><a href="../tables/jsgrid.jsp"
						...
						<li class="nav-item has-treeview"><a href="#"
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item"><a href="../examples/projects.jsp"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Projects</p>
								</a></li>
								<li class="nav-item"><a href="../examples/project_add.jsp"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Project Add</p>
								</a></li>
								<li class="nav-item"><a href="../examples/project_edit.jsp"
									class="nav-link"> <i class="far fa-circle nav-icon"></i>
										<p>Project Edit</p>
								</a></li>
								<li class="nav-item"><a
									href="../examples/project_detail.jsp" class="nav-link"> <i
					...
					<li class="nav-item"><a href="../examples/contacts.jsp"
						class="nav-link"> <i class="nav-icon fas fa-address-book"></i>
							<p>Contacts</p>
					</a></li>
					...
					<li class="nav-item has-treeview"><a href="#" class="nav-link">
						...
						<ul class="nav nav-treeview">
							<li class="nav-item"><a href="../layout/top-nav.jsp"
								class="nav-link"> <i class="far fa-circle nav-icon"></i>
									<p>Top Navigation</p>
							</a></li>
							<li class="nav-item"><a href="../layout/top-nav-sidebar.jsp"
							...
							<li class="nav-item"><a href="../layout/boxed.jsp"
								class="nav-link"> <i class="far fa-circle nav-icon"></i>
									<p>Boxed</p>
							</a></li>
							<li class="nav-item"><a href="../layout/fixed-sidebar.jsp"
								class="nav-link"> <i class="far fa-circle nav-icon"></i>
									<p>Fixed Sidebar</p>
							</a></li>
							<li class="nav-item"><a href="../layout/fixed-topnav.jsp"
								class="nav-link"> <i class="far fa-circle nav-icon"></i>
									<p>Fixed Navbar</p>
							</a></li>
							<li class="nav-item"><a href="../layout/fixed-footer.jsp"
								class="nav-link"> <i class="far fa-circle nav-icon"></i>
									<p>Fixed Footer</p>
							</a></li></li> -->
					</ul>
					...
					<li class="nav-item has-treeview"><a href="#" class="nav-link">
						...
						<ul class="nav nav-treeview">
							...
							<li class="nav-item"><a
								href="../examples/forgot-password.jsp" class="nav-link"> <i
									class="far fa-circle nav-icon"></i>
									<p>Forgot Password</p>
							</a></li>
							<li class="nav-item"><a
								href="../examples/recover-password.jsp" class="nav-link"> <i
									class="far fa-circle nav-icon"></i>
					...
					<div class="row">
						<div class="col-lg-6">
							<c:forEach var="band" items="${bands}" varStatus="status">
								<c:choose>
									<c:when test="${status.current%2==0}">
									band.id %2==0
										<div class="card card-warning card-outline">
											<div class="card-body">
												<h5 class="card-title">${band.bandName }</h5>
												<p class="card-text">
													<a href=""> ${band.bandInfo }</a>
												</p>
