...
<head>
  ...
  <!-- JQVMap -->
  <link rel="stylesheet" href="plugins/jqvmap/
  jqvmap.min.css">
  <!-- Theme style -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                ...
                <a href="*.band?cmd=write"  class="nav-link active">
              ...
              <li class="nav-item">
                ...
                <a href="*.band?cmd=list" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="pages/examples/project_add.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Project Add</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/examples/project_edit.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Project Edit</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="pages/examples/project_detail.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Project Detail</p>
                </a>
              </li>
          ...
          <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="*.user?cmd=login" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Login</p>
                </a>
              </li>
